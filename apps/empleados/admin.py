...
class EmpleadoAdmin(admin.ModelAdmin):
    list_display = ('id_original', 'nombre', 'apellidos', 'departamento', 'cargo', 'estatus', 'tipo_empleado', 'fecha_ingreso')
    list_filter = ('estatus', 'tipo_empleado', 'departamento__area', 'departamento', 'cargo')
    ...
    fieldsets = (
        ...
        ('Configuración Scanner', {
            'fields': ('user', 'id_en_dispositivo', 'tipo_verificacion_scanner', 'foto'),
            'classes': ('collapse',)
        }),
    )
