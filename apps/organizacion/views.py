...
def lista_areas(request):
    ...
    return render(request, 'organizacion/areas.html', {'areas': areas})
...
def nueva_area(request):
    if request.method == 'POST':
        ...
        form = AreaForm()
    return render(request, 'organizacion/formulario.html', {'form': form, 'titulo': 'Nueva Area'})
...
def editar_area(request, pk):
    ...
    return render(request, 'organizacion/formulario.html', {'form': form, 'titulo': 'Editar Area'})


@staff_member_required
def lista_departamentos(request):
    departamentos = Departamento.objects.all().select_related('area')
    return render(request, 'organizacion/departamentos.html', {'departamentos': departamentos})
...
def nuevo_departamento(request):
    ...
    return render(request, 'organizacion/formulario.html', {'form': form, 'titulo': 'Nuevo Departamento'})
...
def editar_departamento(request, pk):
    ...
    return render(request, 'organizacion/formulario.html', {'form': form, 'titulo': 'Editar Departamento'})
